...
def main():
    ...
    parser.add_argument("--n_seed", default=5, type=int,
    ...
    parser.add_argument("--prev_nodes_into_account", default=8, type=int,
...
# python run_opens.py \
# --root_dir ../swde/Processed_SWDE \
# --vertical nbaplayer \
# --n_seed 5 \
# --n_pages 2000 \
# --prev_nodes_into_account 8 \
# --model_name_or_path ../GEM \
